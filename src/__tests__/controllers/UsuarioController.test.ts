// backend/src/__tests__/controllers/UsuarioController.test.ts
import { Request, Response } from 'express';
import { UsuarioController } from '../../infrastructure/controller/UsuarioController';
...
describe('UsuarioController', () => {
  ...
  describe('crear usuario', () => {
    test('should create user successfully', async () => {
      ...
      await UsuarioController.crear(mockReq, mockRes);
  ...
  describe('desactivar usuario', () => {
    test('should deactivate user successfully', async () => {
      ...
      await UsuarioController.desactivar(mockReq, mockRes);
