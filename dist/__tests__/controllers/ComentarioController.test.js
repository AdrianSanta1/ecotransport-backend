...
const ComentariosController_1 = require("../../infrastructure/controller/ComentariosController");
// Mock de TypeORM
...
describe('ComentarioController', () => {
    ...
    describe('crear comentario', () => {
        test('should create comment successfully', async () => {
            ...
            await ComentariosController_1.ComentarioController.crear(mockReq, mockRes);
    ...
    describe('listar comentarios', () => {
        test('should list comments by user', async () => {
            ...
            await ComentariosController_1.ComentarioController.listarPorUsuario(mockReq, mockRes);
    ...
    describe('actualizar comentario', () => {
        test('should update comment successfully', async () => {
            ...
            await ComentariosController_1.ComentarioController.actualizar(mockReq, mockRes);
    ...
    describe('eliminar comentario', () => {
        test('should delete comment successfully', async () => {
            mockReq.params = { id: '1' };
            await ComentariosController_1.ComentarioController.eliminar(mockReq, mockRes);
...
//# sourceMappingURL=ComentarioController.test.js.map